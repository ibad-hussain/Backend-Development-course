...
app.get("/delete", async (req, res) => {
    let deletedUser = await userModel.findOneAndDelete({name: "abc"});
...
app.get("/deletepost", async (req, res) => {
    let deletedUser = await postModel.findOneAndDelete({_id: "67a929cf510c886a0e295d10"});
    res.send(deletedUser);
});
